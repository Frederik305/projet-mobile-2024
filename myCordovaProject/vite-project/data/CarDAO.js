...
class CarDAO{
    constructor(){
        this.cars = [
            {id: 0, name: "Muscle", model: "Muscle.glb", acceleration: 1.5, baseMaxSpeed: 50, weight: 1000, brakePower: 1, maneuverability: 20, rotation: 0.03, cameraDistance: 800, cameraRotationY: 400, cameraRotationX: 0},
            {id: 1, name: "Sedan", model: "Sedan.glb", acceleration: 2, baseMaxSpeed: 50, weight: 1000, brakePower: 1, maneuverability: 10, rotation: 0.03, cameraDistance: 800, cameraRotationY: 400, cameraRotationX: 0},
