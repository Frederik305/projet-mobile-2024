class CarDAO{
    constructor(){
        this.cars = [
            ...
            {id: 1, name: "Jeep", model: "Sedan.glb", acceleration: 1.1, baseMaxSpeed: 50, currentSpeed: 20, weight: 1000, brakePower: 1, maneuvrability: 10, rotation: 0.03, cameraDistance: 2500, cameraRotationY: 1500, cameraRotationX: 500},
        ];
    }
